...
class TestBase(TestCase):
    ...
    def test_ba(self):
        """Defining a function that tests the starting point of creation of Base"""
        base = Base()
        base_1 = Base()
        base_89 = Base(89)
    ...
    def test_to_json_string(self):
        """Defining a function that tests the converting of lists to dicts"""
    ...
    def test_save_to_file(self):
        """Defining a function that test that the file saves list objects to  file"""
    ...
    def test_from_json_string(self):
        """Defining a function that tests the JSON string"""
